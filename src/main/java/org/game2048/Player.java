...
public class Player {
    ...
    /*
    Наилучший алгоритм к которому я пришел. Смотрит на два шага вперед и после выбирает совокупность движений, которая
    принесет больше очков. В целом не отличается от того, как играю в 2048 я. В поиске улучшения моего алгоритма
    нашел эту статью https://www.baeldung.com/cs/2048-algorithm. Решил, что переписывать готовое решение будет
    неправильным.
     */
